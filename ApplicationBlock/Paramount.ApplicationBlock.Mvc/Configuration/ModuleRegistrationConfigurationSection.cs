...
namespace Paramount.ApplicationBlock.Mvc.Configuration
{
    public class ModuleRegistrationSection : ConfigurationSection
    {
        private static ModuleRegistrationSection settings
    = ConfigurationManager.GetSection("moduleregistration") as ModuleRegistrationSection;
