...
IF NOT EXISTS ( SELECT 1 FROM EmailTemplate WHERE DocType = 'ExpirationReminder' )
begin
...
SET	[SubjectTemplate]  = 'Extend Your Expiring Ad',
        ...
        <tbody>
            ...
            <tr>
                <td valign="top" style="width: 600px;">
                    ...
                    <p class="mainPara">
                        This is a reminder that your ad(s) are about to expire.
                    </p>
                    <p class="mainPara">[/AdReference/]</p>
                    <p class="mainPara">
                        Skip the booking process by <a href="[/LinkForExtension/]" target="_blank">extending your ad online.</a>
                    </p>
                    <br />
                    <p
                        class="mainPara">
