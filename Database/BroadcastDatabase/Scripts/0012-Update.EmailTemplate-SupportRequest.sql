...
SET	[SubjectTemplate]  = 'Classies Support Request',
        ...
        <tbody>
            ...
            <tr>
                <td valign="top" style="width: 600px;">
                    <h2 class="headline">Classies Support Request</h2>
                    <p class="mainPara">
                        A support request has been submitted by <strong>[/name/]</strong> and they are awaiting your response.
                    </p>
                    <br/>
                    <p class="mainPara">Email: [/email/]</p>
                    <br />
                    <p class="mainPara">Phone: [/phone/]</p>
                    <br />
                    <p class="mainPara">Comment: [/content/]</p>
                    <br />
                    <p class="mainPara">Please get back to <strong>[/name/]</strong> by at least one of the communication methods provided by the user above.</p>
                </td>
            </tr>
            <tr>
                <td valign="top" style="width: 600px;">
