...
IF NOT EXISTS ( SELECT 1 FROM EmailTemplate WHERE DocType = 'AdShare' )
begin
...
SET	[SubjectTemplate]  = '[/ClientName/] - [/AdTitle/]',
        ...
        <tbody>
            ...
            <tr>
                <td valign="top" style="width: 600px;">
					...
					Posted by [/AdvertiserName/]. Click here to contact advertiser.
                    <br />
