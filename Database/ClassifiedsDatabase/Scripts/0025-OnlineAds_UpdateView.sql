...
/****** Object:  View [dbo].[OnlineAds]    Script Date: 6/07/2014 9:00:11 PM ******/
SET ANSI_NULLS ON
GO
...
ALTER VIEW [dbo].[OnlineAds]
AS
SELECT        o.OnlineAdId, o.AdDesignId, o.Heading, o.Description, o.HtmlText, o.Price, o.LocationId, o.LocationAreaId, o.ContactName, o.ContactPhone, o.ContactEmail, 
