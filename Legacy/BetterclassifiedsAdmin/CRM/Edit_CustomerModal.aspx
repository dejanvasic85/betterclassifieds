<%@ Page Title="" Language="vb" AutoEventWireup="false"  CodeBehind="Edit_CustomerModal.aspx.vb" Inherits="BetterclassifiedAdmin.CRM.Edit_CustomerModal" %>
                                ...
                                <tr>
                                    <td valign="top" style="width: 445px">
                                        ...
                                        <asp:ObjectDataSource ID="MemberData" runat="server" 
                                            ...
                                            TypeName='BetterclassifiedAdmin.Configuration.CustomerMemberShip'>
                                            <SelectParameters>
                                ...
                                <tr>
                                    ...
                                    <td width="300">
                                        <asp:DropDownList runat="server" ID="ddlNewsletter">
                                            ...
                                            <asp:ListItem Text="Subscribe to newsletter" Value="true" />
                                        </asp:DropDownList>
                                    </td>
                                </tr>
                            </table>
