<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/masterpage/MasterPage.master" CodeBehind="Search_Customer.aspx.vb" Inherits="BetterclassifiedAdmin.CRM.Search_Customer" %>
        ...
        <asp:GridView ID="UsersGridView" runat="server" AutoGenerateColumns="False" onrowcreated="UserAccounts_RowCreated" onrowdeleting="UserAccounts_RowDeleting" DataKeyNames="userName" EmptyDataText="No records found." >
          <Columns>
            ...
            <asp:TemplateField>
                ...
                <ItemTemplate>
                    <a href='edit_customerModal.aspx?username=<%# Eval("UserName") %>' rel="gb_page_center[525, 600]" title="Edit User Details"><%# Eval("UserName") %></a>
                </ItemTemplate>
            </asp:TemplateField>          
            ...
            <asp:ButtonField CommandName="Delete" ButtonType="Image" ImageUrl="~/App_Themes/blue/images/delete.gif" >
                <ItemStyle HorizontalAlign="Center" />
            </asp:ButtonField>
        </Columns>
    </asp:GridView>
