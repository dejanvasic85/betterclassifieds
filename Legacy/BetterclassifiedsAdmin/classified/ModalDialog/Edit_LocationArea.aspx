<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Edit_LocationArea.aspx.vb" Inherits="BetterclassifiedAdmin.Edit_LocationArea" %>
                ...
                <ajax:TabContainer ID="tcntLocation" runat="server" ActiveTabIndex="0" 
                    ...
                    <ajax:TabPanel ID="TabPanel2" runat="server" HeaderText="General Info">
                        ...
                        <div style="font-size: 11px;">
                            ...
                            <asp:DetailsView ID="dtlLocationArea" runat="server" AutoGenerateRows="False"
                                style="width: 445px" HeaderText="Location Area Details"
                                DefaultMode="Edit" DataKeyNames="LocationAreaId" DataSourceID="linqSource">
                                <Fields>
                            ...
                            <asp:LinqDataSource ID="linqSource" runat="server" EnableUpdate="true" EnableObjectTracking="false"
                                 ContextTypeName="BetterclassifiedsCore.DataModel.BetterclassifiedsDataContext" TableName="LocationAreas" />
                        </div>
                        </ContentTemplate>
                    </ajax:TabPanel>
                </ajax:TabContainer>
