<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/masterpage/MasterPage.master" CodeBehind="Users.aspx.vb" Inherits="BetterclassifiedAdmin.UserAdmin.Users" %>
        ...
        <asp:GridView ID="UsersGridView" runat="server" AutoGenerateColumns="False" onrowcreated="UserAccounts_RowCreated" onrowdeleting="UserAccounts_RowDeleting" DataKeyNames="userName" EmptyDataText="No records found.">
            <Columns>
                ...
                <asp:TemplateField>
                    ...
                    <ItemTemplate>
                        <a href='Edit_UsersModal.aspx?username=<%# Eval("UserName") %>' rel="gb_page_center[525, 600]" title="Edit User Details"><%# Eval("UserName") %></a>
                    </ItemTemplate>
                </asp:TemplateField>          
