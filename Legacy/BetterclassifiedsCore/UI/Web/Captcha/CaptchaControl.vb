...
Namespace UI.Web.Captcha
    ''' <summary>
    ''' Catpcha Control used for Web security enabling SPAM prevention.
    ''' </summary>
    ''' <remarks>
    ''' Add a reference to the CaptchaControl to your toolbox;
    ''' then just drag and drop the control on a web form and set properties on it. 
    '''</remarks>
    <DefaultProperty("Text")> _
    <ToolboxData("<{0}:ParamountCaptcha runat=server></{0}:GridView>")> _
    Public Class CaptchaControl
        ...
        Private _timeoutSecondsMax As Integer = 300
...
#End Region
        ...
        Private Sub ValidateCaptcha(ByVal userEntry As String)
            ...
            If ci Is Nothing Then
                Dim timeoutmins As Integer = Me.CaptchaMaxTimeout / 60
                Me.ErrorMessage = "The code you typed has expired after " & timeoutmins.ToString & " minutes."
