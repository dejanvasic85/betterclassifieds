...
namespace Paramount.DSL.UIController
{
    public class DslQueryParam
    {
        ...
        public int Resolution
        {
            get
            {
                return string.IsNullOrEmpty(collectionData[resolutionKey]) ? ConfigSettingReader.DslDefaultResolution : int.Parse(collectionData[resolutionKey]);
            }
            set
            {
        ...
        {
            //var query = CryptoHelper.Encrypt(url);
