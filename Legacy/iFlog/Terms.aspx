<%@ Page Language="vb" AutoEventWireup="false" MasterPageFile="~/Master/MasterWithRightBar.Master"
    CodeBehind="Terms.aspx.vb" Inherits="BetterclassifiedsWeb.Terms" Title="TheMusic Classies  Terms and Conditions" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="BodyPlaceHolder" runat="server">
    <div id="mainInfo">
        ...
        <div id="mainContentInfo">
            <p>
                <h3>ADVERTISING TERMS AND CONDITIONS</h3>
            </p>
            <p>
                <b>TheMusic Classies  is operated under licence by Dharma Media Pty Ltd (ABN: 54 117 132 402). Dharma
                    Media Pty Ltd is part of the Street Press Australia Pty Ltd group of companies.</b>
            </p>
            <%--<p>
                        TheMusic Classies  is owned and operated by Street Press Australia Pty Ltd<br />
                    </p>--%>
            <h4>1. Publication of Advertising</h4>
            <p>
                1.1 Subject to these Terms, TheMusic Classies  will use its reasonable endeavours to publish
                ...
                TheMusic Classies  may, in its discretion and without further cost to the Customer, re-publish
                Advertising in TheMusic Classies  publications.
            </p>
            <h4>2. Right to Refuse or Withdraw Advertising
            </h4>
            <p>
                2.1 Neither these Terms nor any written or verbal quotation by TheMusic Classies  represent an
                offer to publish Advertising. A binding contract in relation to a request for Advertising
                will only be formed between TheMusic Classies  and a Customer when TheMusic Classies  accepts Advertising
                in writing or generates a GST compliant invoice for that Advertising. 2.2 Even if
                a contract has been formed in accordance with the above clause, TheMusic Classies  reserves the
                right to refuse or withdraw from publication any Advertising at any time without
                giving reasons (even if the Advertising has previously been published by TheMusic Classies ).
            </p>
            <h4>3. Right to Vary Format and Placement
            </h4>
            <p>
                3.1 TheMusic Classies  reserves the right; (a) to vary the placement of Advertising. (b) to change
                the format of print Advertising (including but not limited to changing a format
                from colour to black and white). 3.2 TheMusic Classies  will endeavour to notify the Customer
                of any such changes. However, except in accordance with clause 11. TheMusic Classies  will not
                be liable for any costs, expenses, losses or damages suffered or incurred by a Customer
                arising from TheMusic Classies ’s failure to publish Advertising in accordance with a Customer’s
                request.
            </p>
            <h4>4. Submission of Advertising
            </h4>
            <p>
                4.1 By submitting Advertising for publication, the Customer warrants to TheMusic Classies  that
                ...
                Post office box and email addresses alone are insufficient. 4.3 If, in TheMusic Classies ’s opinion,
                a Customer submits Advertising that looks like editorial material, TheMusic Classies  may publish
                ...
                to TheMusic Classies  immediately after publication. TheMusic Classies  will endeavour to take reasonable
            ...
            <h4>5. Classified Advertising
            </h4>
            <p>
                5.1 TheMusic Classies  will publish classified Advertising under the classification heading that
                it reasonably believes is most appropriate. Classified Advertising headings are
                for the convenience of readers and are determined at the discretion of TheMusic Classies . 5.2
                TheMusic Classies  will publish classified display Advertising sorted by alphabetical caption
            ...
            <p>
                ...
                Customer by TheMusic Classies ; and (b) notify TheMusic Classies  of any errors in the proofs or any published
                Advertising. 6.2 TheMusic Classies  does not accept responsibility for any errors in print Advertising
                placed over the telephone. 6.3 If a Customer wishes to make a claim on TheMusic Classies  for
                credit, re-publication or any other remedy in respect of Advertising, the Customer
                must send the claim in writing to TheMusic Classies  no later than 25 days after the date of
                the tax invoice or date of publication of the Advertising (whichever is earlier).
                6.4 TheMusic Classies  will only investigate complaints during normal office hours (9am to 5pm,
                Monday to Friday excluding public holidays).
            </p>
            <h4>7. Advertising Rates and Taxes
            </h4>
            <p>
                7.1 The Customer must pay for Advertising in accordance with the rates in TheMusic Classies ’s
                Advertising Ratecard (and, unless otherwise agreed, at the casual or basic rate).
                The rates in the Ratecard: (a) may be varied at any time by TheMusic Classies  without notice;
                ...
                equal to any Taxes payable by TheMusic Classies  in respect of Advertising. TheMusic Classies  will provide
            ...
            <p>
                8.1 TheMusic Classies  may grant, deny or withdraw credit to a Customer at any time in its discretion.
            ...
            <p>
                ...
                TheMusic Classies ; (b) if account, within 7 days after the date of the invoice. 10.2 The Customer
                ...
                TheMusic Classies  has exercised its right to vary the format or placement of the Advertising;
                and (ii) any error or omission in the Advertising (unless the error or omission
                was the fault of TheMusic Classies ).
            </p>
            <h4>10. Failure to Pay and other Breach
            </h4>
            <p>
                10.1 If a Customer fails to pay for Advertising in accordance with clause 10 or
                if a Customer suffers an Insolvency Event as defined in clause 11.2, TheMusic Classies  may (in
                ...
                the Customer all costs relating to any action taken by TheMusic Classies  to recover amounts
                ...
                any petition is presented for the winding up of the Customer. 10.3 TheMusic Classies  reserves
                ...
                employee of TheMusic Classies  shall be prima facie evidence and proof of the amount owed by
                the Customer to TheMusic Classies .
            </p>
            <h4>11. Liability
            </h4>
            <p>
                11.1 The Customer acknowledges that it has not relied on any advice given or representation
                made by or on behalf of TheMusic Classies  in connection with the Advertising. 11.2 TheMusic Classies  excludes
                ...
                11.3 TheMusic Classies  limits its liability: (a) for breach of any Non-Excludable Condition
                (to the extent that liability for such breach can by law be limited); and (b) for
                any other error or omission in published Advertising caused by TheMusic Classies , to (at TheMusic Classies ’s
                option) resupply of the Advertising services affected by the breach, or payment
                of the cost of re-supply. 11.4 Subject to clauses 11.2 and 11.3, TheMusic Classies  excludes
                ...
                published by TheMusic Classies , whether that liability arises in contract, tort (including by
                TheMusic Classies ’s negligence) or under statute. Without limitation, TheMusic Classies  will in no circumstances
                be liable for any indirect or consequential losses, including loss of profits, loss
                of revenue and loss of business opportunity. 11.5 The Customer indemnifies TheMusic Classies 
            ...
            <p>
                12.1. The personal information provided by Customer is collected and stored by TheMusic Classies 
                ...
                submitted (if any), and internal marketing campaigns. TheMusic Classies  may disclose personal
                ...
                information by contacting the TheMusic Classies Locked Bag 2001, Clifton Hill VIC 3068. 
                12.3 If the Customer does not provide the requested information,
                it will not be possible to supply the Customer with advertising and/or other services.
            </p>
            <h4>13. General
            </h4>
            <p>
                13.1 These Terms represent the entire agreement of the Customer and TheMusic Classies  in relation
                to Advertising and cannot be varied except in writing by an authorised officer of
                TheMusic Classies . No purchase order or other document issued by the Customer will vary these
                Terms. 13.2 TheMusic Classies  will not be liable for any delay or failure to publish Advertising
                caused by a factor outside TheMusic Classies ’s reasonable control (including but not limited
                to any Act of God, war, breakdown of plant, industrial dispute, electricity failure,
                governmental or legal restraint). 13.3 TheMusic Classies  may service any notice or court documents
            ...
            <p>
                TheMusic Classies  is owned and operated by Street Press Australia Pty Ltd ABN 76 117 128 579<br />
                <br />
                Address: Locked Bag 2001, Clifton Hill VIC 3068<br />
                Telephone: (03) 9421 4499<br />
            </p>
            <p>
                &nbsp;
            </p>
            ...
            <p>
                These terms and conditions, together with the TheMusic Classies  Privacy Policy and any additional
            ...
            <h4>Street Press Australia Websites
            </h4>
            <p>
            ...
            <ol>
                <li>to transmit (or authorise the transmission of) &quot;junk mail,&quot; &quot;chain
                    letters,&quot; unsolicited emails, instant messaging, &quot;spimming,&quot; or &quot;spamming&quot;;</li>
            ...
            <ol>
                <li>is not your original work, or which in any way violates or infringes (or could reasonably
                    be expected to violate or infringe) the intellectual property or other rights of
                    another person;</li>
                <li>contains, promotes, or provides information about unlawful activities or conduct;
                </li>
                <li>is, or could reasonably be expected to be, defamatory, obscene, offensive, threatening,
                    ...
                    gender, age, sexual orientation or any physical or mental disability;</li>
                <li>exploits another person in any manner;</li>
                <li>contains nudity, excessive violence, or sexual acts or references;</li>
                <li>includes an image or personal information of another person or persons unless you
                    have their consent;</li>
                <li>poses or creates a privacy or security risk to any person; </li>
                <li>you know or suspect (or ought reasonably to have known or suspected) to be false,
                ...
                <li>contains viruses, or other computer codes, files or programs designed to interrupt,
                    limit or destroy the functionality of other computer software or hardware; </li>
                <li>advertises, promotes or solicits any goods or services or commercial activities
                    (except where expressly permitted or authorised by us); or </li>
            ...
            <ol>
                <li>review, modify, reformat, reject or remove any Material which you upload, post,
                    ...
                    potential to harm, endanger or violate the rights of any person; and</li>
                <li>monitor use of our sites, and store or disclose any information that we collect,
                    including in order to investigate compliance with the Conditions or for the purposes
                    of any police investigation or governmental request. </li>
            </ol>
            <p>
            ...
            <h4>Third party websites, advertising and activities
            </h4>
            <p>
            ...
            <ol>
                <li>(i) the re-supply of those services; or</li>
                <li>(ii) the payment of the cost of having those services re-supplied; and</li>
            </ol>
            <p>
                (b) in the case of goods supplied or offered by us:
            </p>
            <ol>
                <li>(i) the replacement of the goods or the supply of equivalent goods;</li>
                <li>(ii) the repair of the goods;</li>
                <li>(iii) the payment of the cost of having the goods replaced; or</li>
                <li>(iv) the payment of the cost of having the goods repaired.<br />
            ...
            <h4>Affirmation regarding age</h4>
            <p>
            ...
            <p>
                &quot;Conditions&quot; means these terms and conditions, together with the TheMusic Classies 
