...
namespace Paramount.Betterclassifieds.Business.Events
{
    public interface IEventManager
    {
        ...
        EventBooking CreateEventBooking(int eventId, ApplicationUser applicationUser, IEnumerable<EventTicketReservation> currentReservations, Func<string, string> barcodeUrlCreator);
        ...
        EventOrganiser CreateEventOrganiser(int eventId, string username);
    }
}