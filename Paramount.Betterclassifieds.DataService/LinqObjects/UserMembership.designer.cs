...
namespace Paramount.Betterclassifieds.DataService.LinqObjects
{
    ...
    partial void OnConfirmationAttemptsChanged();
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_HowYouFoundUs", DbType="VarChar(100)", UpdateCheck=UpdateCheck.Never)]
		public string HowYouFoundUs
		{
			get
			{
				return this._HowYouFoundUs;
			}
			set
			{
				if ((this._HowYouFoundUs != value))
				{
					this.OnHowYouFoundUsChanging(value);
					this.SendPropertyChanging();
    ...
    partial void OnRequiresEventOrganiserConfirmationChanged();
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_HowYouFoundUs", DbType="VarChar(100)")]
		public string HowYouFoundUs
		{
			get
			{
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_PreferredPaymentMethod", DbType="VarChar(30)")]
		public string PreferredPaymentMethod
		{
			...
			set
			{
				if ((this._PreferredPaymentMethod != value))
				{
					this.OnPreferredPaymentMethodChanging(value);
					this.SendPropertyChanging();
