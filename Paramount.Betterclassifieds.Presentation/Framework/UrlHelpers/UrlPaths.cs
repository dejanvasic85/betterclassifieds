...
namespace Paramount
{
    public static class UrlPaths
    {
        ...
        public static UrlBuilder UserAds(this UrlHelper urlHelper)
        {
            return new UrlBuilder(urlHelper).WithAction("index", "userads");
        }
        ...
        {
            return new UrlBuilder(urlHelper, "details", "editAd", new { id = adId });
        }
        ...
        public static UrlBuilder EventTicketManagement(this UrlHelper urlHelper, int adId, int eventId)
        {
            return new UrlBuilder(urlHelper)
                .WithAction("manage-tickets", "editad")
