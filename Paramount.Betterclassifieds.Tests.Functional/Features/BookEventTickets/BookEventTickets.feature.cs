...
#line 31
 testRunner.Then("the ticket \"General Admission\" price should be \"$5.50\"", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "Then ");
#line 32
 testRunner.Then("the ticket \"VIP\" price should be \"$10.69\"", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "Then ");
#line hidden
            this.ScenarioCleanup();
        }
