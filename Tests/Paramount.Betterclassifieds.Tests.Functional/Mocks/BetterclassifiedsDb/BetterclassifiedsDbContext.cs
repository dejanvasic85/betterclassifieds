...
namespace Paramount.Betterclassifieds.Tests.Functional.Mocks.BetterclassifiedsDb
{
    ...
    public partial class BetterclassifiedsDbContext : DbContext
    {
        static BetterclassifiedsDbContext()
        {
            Database.SetInitializer(new BetterclassifiedsDbInitialiser());
        }
        ...
        public DbSet<PublicationSpecialRate> PublicationSpecialRates { get; set; }
        ...
        public DbSet<OnlineAd1> OnlineAds1 { get; set; }
        ...
        protected override void OnModelCreating(DbModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Configurations.Add(new PublicationSpecialRateMap());
            modelBuilder.Configurations.Add(new PublicationTypeMap());
            modelBuilder.Configurations.Add(new RatecardMap());
            modelBuilder.Configurations.Add(new SchemaVersionMap());
            ...
            modelBuilder.Configurations.Add(new OnlineAd1Map());
