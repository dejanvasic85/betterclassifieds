<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/masterpage/MasterPage.master" CodeBehind="Add_Customer.aspx.vb" Inherits="BetterclassifiedAdmin.CRM.Add_Customer"  theme="blue" stylesheettheme="blue"%>
...
<asp:Content ID="Content7" runat="server" contentplaceholderid="cphContentBody">
    ...
    <asp:CreateUserWizard ID="RegisterUserWithRoles" runat="server" 
        ContinueDestinationPageUrl="~/crm/Add_Customer.aspx"
