<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Edit_BusinessCategory.aspx.vb" Inherits="BetterclassifiedAdmin.Edit_BusinessCategory" %>
                ...
                <ajax:TabContainer ID="tcntLocation" runat="server" ActiveTabIndex="0" 
                    ...
                    <ajax:TabPanel ID="TabPanel2" runat="server" HeaderText="General Info">
                        ...
                        <div style="font-size: 11px;">
                            ...
                            <asp:DetailsView ID="dtlBusinessCategory" runat="server" AutoGenerateRows="False"
                                style="width: 445px" HeaderText="Business Category Details"
                                DefaultMode="Edit" DataKeyNames="BusinessCategoryId" DataSourceID="linqSource">
                                <Fields>
                            ...
                            <asp:LinqDataSource ID="linqSource" runat="server" EnableUpdate="true" EnableObjectTracking="false"
                                 ContextTypeName="BetterclassifiedsCore.DataModel.AppUserDataContext" TableName="BusinessCategories" />
                        </div>
                        </ContentTemplate>
                    </ajax:TabPanel>
                </ajax:TabContainer>
