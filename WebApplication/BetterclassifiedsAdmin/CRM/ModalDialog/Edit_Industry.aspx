<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Edit_Industry.aspx.vb" Inherits="BetterclassifiedAdmin.Edit_Industry" %>
                ...
                <ajax:TabContainer ID="tcntLocation" runat="server" ActiveTabIndex="0" 
                    ...
                    <ajax:TabPanel ID="TabPanel2" runat="server" HeaderText="General Info">
                        ...
                        <div style="font-size: 11px;">
                            ...
                            <asp:DetailsView ID="dtlIndustry" runat="server" AutoGenerateRows="False"
                                style="width: 445px" HeaderText="Industry Details"
                                DefaultMode="Edit" DataKeyNames="IndustryId" DataSourceID="linqSource">
                                <Fields>
                            ...
                            <asp:LinqDataSource ID="linqSource" runat="server" EnableUpdate="true" EnableObjectTracking="false"
                                 ContextTypeName="BetterclassifiedsCore.DataModel.AppUserDataContext" TableName="Industries" />
                        </div>
                        </ContentTemplate>
                    </ajax:TabPanel>
                </ajax:TabContainer>
