...
<asp:Content ID="Content4" ContentPlaceHolderID="cphContentBody" runat="server">
    ...
    <table cellspacing="2">
        ...
        <tr>
            <td>
                <telerik:RadComboBox ID="radComboPublication" runat="server"
                    DataTextField="Title" DataValueField="PublicationId"
                    AutoPostBack="true" CausesValidation="false" Skin="WebBlue" />
            </td>
        </tr>
        <tr>
            <td>
        ...
        <tr>
            <td>
                <telerik:RadComboBox ID="radComboEdition" runat="server"
            ...
            <td>
                <telerik:RadDatePicker ID="radDatePicker" runat="server"
                    AutoPostBack="true" SkinID="WebBlue" CausesValidation="false" />
            </td>
            <td>
                <asp:Button ID="btnSubmit" runat="server" Text="View Ads" Visible="false" /></td>
        </tr>
    </table>
