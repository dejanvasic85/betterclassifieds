<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Edit_webContent.aspx.vb" Inherits="BetterclassifiedAdmin.Edit_webContent" %>
...
<body>
    ...
    <div>
        <asp:detailsview id="DetailsView1" runat="server" height="50px" 
            ...
            width="100%">
            <fields>
                <asp:boundfield datafield="EntityGroup" headertext="Entity Group" 
                    sortexpression="EntityGroup" />
                <asp:boundfield datafield="CultureCode" headertext="Culture Code" 
               ...
               <headerstyle  cssclass=""/>
                <insertitemtemplate >
                     <fckeditorv2:fckeditor ID="WYSIWYGEditor_EmailBody" runat="server"
                         BasePath="~/FCKeditor/" Height="400px" Value='<%# Bind("EntityValue")%>'>
                ...
                <edititemtemplate >
                   ...
                   <%--   <asp:boundfield datafield="EntityValue" headertext="Entity Value" 
                    sortexpression="EntityValue" />--%>
