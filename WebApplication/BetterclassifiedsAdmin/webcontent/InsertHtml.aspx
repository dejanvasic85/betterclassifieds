<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="InsertHtml.aspx.vb" Inherits="BetterclassifiedAdmin.InsertHtml" %>
            ...
            <fields>
                ...
                <asp:boundfield datafield="EntityKey" headertext="Entity Key" 
                 ...
                 <asp:templatefield headertext="Entity Type" >
                    <insertitemtemplate  >
                           <asp:textbox id="TextBox1" runat="server" readonly="true" text='<%# Bind("EntityType")%>'>HTML</asp:textbox> 
                    </insertitemtemplate>
                  </asp:templatefield>
