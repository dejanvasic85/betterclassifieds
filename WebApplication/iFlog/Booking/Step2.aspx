...
<%@ Register Src="~/Controls/Booking/PaperListSelection.ascx" TagName="PaperListSelection"
    TagPrefix="ucx" %>
        ...
        <div id="contentBodyAccounts">
            <div id="mainBookAd">
                <%--<div id="mainHeaderBookAd">
                    <ucx:NavigationSteps runat="server" ID="nav" StepNumber="2" Instruction="Please select pulication(s)"
                        Description="Please specify the publication(s) and category where you like to place your ad." />
                </div>--%>
