    ...
    <WizardSteps>
        ...
        <asp:WizardStep ID="wizCreateUser" runat="server">
            ...
            <div id="myAccountTableChgDet">
                <table width="360" border="0" cellspacing="10px 10px 0px 10px" cellpadding="0px">
                    ...
                    <tr>
                        <td><asp:TextBox ID="Address1TextBox" runat="server" size="40%" />
            ...
            <div id="myAccountTableChgDet">
                <table width="360" border="0" cellspacing="10px 10px 0px 10px" cellpadding="0px">
                    ...
                    <tr>
                        <td><asp:TextBox ID="CityTextBox" runat="server" size="40%" />
            ...
            <div id="myAccountTableChgDet">
                <table width="750" border="0" cellspacing="10px 10px 0px 10px" cellpadding="0px">
                    <tr>
                        <td width="360"><p>State or Territory*</p></td>
                        <td width="360"><p>Postcode*</p></td>
                    </tr>
                    <tr>
                        <td width="360">
        ...
        <asp:CreateUserWizardStep ID="CreateUserWizardStep1" runat="server">
            <ContentTemplate>
                ...
                <div id="myAccountTableChgDet">
                    <h3>
                        Choose username and password</h3>
                </div>
                        ...
                        <tr>
                            <td width="360">
                                <p>
                                    ...
                                    <asp:Label ID="Label2" runat="server" Text="Create your username"></asp:Label>*</asp:Label></p>
                            </td>
                            <td width="360"></td>
                        </tr>
                        <tr>
                            ...
                            <td width="360">
                                <div class="verify">
                                    <asp:UpdatePanel ID="pnlCheckUsername" runat="server">
                                        <ContentTemplate>
                                            <asp:LinkButton ID="btnCheckUsername" runat="server" OnClick="Check_Username">check username availability</asp:LinkButton>
                ...
                <div id="myAccountTableChgDet">
                    <table width="360" border="0" cellspacing="10px 10px 0px 10px" cellpadding="0px">
                        <tr>
                            <td width="360">
                                <p>
                                    ...
                                    <asp:Label ID="Label4" runat="server" Text="Create your password"></asp:Label>*</asp:Label></p>
                            </td>
                        </tr>
                        <tr>
                            <td width="360">
                        ...
                        <tr>
                            <td width="360"><p style="font-size: 10px; font-weight: normal;">Password must be at least 6 characters</p></td>
                        </tr>
                    </table>
                </div>
                    ...
                    <table width="360" border="0" cellspacing="10px 10px 0px 10px" cellpadding="0px">
                        <tr>
                            <td width="360">
                                ...
                                <asp:Label ID="Label22" runat="server" Text="Confirm Password"></asp:Label>*</asp:Label></p>
                            </td>
                        </tr>
                        <tr>
                            <td width="360">
                        ...
                        <tr>
                            <td width="360">
                                <p>
                                    ...
                                    <asp:Label ID="Label23" runat="server" Text="E-mail"></asp:Label>*</asp:Label></p>
                            </td>
                        </tr>
                        <tr>
                            <td width="360">
                ...
                <div id="myAccountTableChgDet">
                   <table width="360" border="0" cellspacing="10px 10px 0px 10px" cellpadding="0px" 
                        ...
                        <tr>
                            <td width="360">
                                <p>Please provide the code you see below*</p>
                            </td>
                        </tr>
                        <tr>
                            <td width="390">
                                <paramountIt:CaptchaControl ID="ParamountCaptcha" runat="server" 
                                    CaptchaBackgroundNoise="Medium" CaptchaFontWarping="Medium" CaptchaWidth="200" 
                                    Text="" Height="25px" Width="403px" /></td>
                        </tr>
                        <tr>
                            <td>
