...
<div id="mainContentMyAccount">
    ...
    <asp:ChangePassword ID="ChangePassword1" runat="server" 
            ...
            <ChangePasswordTemplate>
                ...
                <div id="myAccountTableButtonsPw">
                    <ul style="width: 230px;">
                        <div id="myAccountTableButtonsCancel">
                            <li>
                                <asp:LinkButton ID="CancelPushButton" runat="server" CausesValidation="False" 
                        ...
                        <div id="myAccountTableButtonsExtend">
                            <li>
                                ...
                                <asp:LinkButton ID="ChangePasswordPushButton" runat="server" 
                                    CommandName="ChangePassword" Text="CHANGE" 
