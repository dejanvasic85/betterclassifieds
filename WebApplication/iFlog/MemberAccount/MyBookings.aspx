<%@ Page Title="My Bookings" Language="vb" AutoEventWireup="false" ClientIDMode="Predictable" CodeBehind="MyBookings.aspx.vb" Inherits="BetterclassifiedsWeb.MyBookings" MasterPageFile="~/Master/MemberDetails.master" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="memberContentMain" runat="server">
    ...
    <div class="accountRow">
        <asp:Panel runat="server" ID="pnlBookingsAboutToExpireAlert" CssClass="alert alert-warning">
                ...
                <tr runat="server" id="row">
                    ...
                    <td style="width: 80%">
                        ...
                        <div class="btn-group pull-right" style="padding-top: 10px;">
                            ...
                            <asp:HyperLink runat="server" ID="lnkBookAgain" Text="Book Again" CssClass="btn btn-default" Visible="False" />
                            <asp:HyperLink runat="server" ID="lnkEditOnlineAd" Text="Edit Online" CssClass="btn btn-default" />
                            <asp:HyperLink runat="server" ID="lnkEditLineAd" Text="Edit Print" CssClass="btn btn-default" />
                        </div>
